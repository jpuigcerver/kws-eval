...
TEST(OptionTest, Help) {
  int opt_int_val = -1;
  Option<int> opt_int("int", "int help", &opt_int_val);
  EXPECT_EQ("--int : int help (default = -1)", opt_int.Help());
  EXPECT_EQ("--int        : int help (default = -1)", opt_int.Help(10));

  bool opt_bool_val = true;
  Option<bool> opt_bool("bool", "bool help", &opt_bool_val);
  EXPECT_EQ("--bool : bool help (default = true)", opt_bool.Help());
  EXPECT_EQ("--bool       : bool help (default = true)", opt_bool.Help(10));
}
